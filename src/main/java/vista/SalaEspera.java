...
public class SalaEspera extends javax.swing.JFrame implements IActualizable{
    ...
    public void recibirJugadores(List<Jugador> jugadores) {
        for (int i = 0; i < jugadores.size(); i++) {
            switch (i) {
                case 0:
                    this.lblJugador1.setIcon(new ImageIcon("src\\main\\resources\\" + jugadores.get(i).getAvatar()));
                    this.lblNombre1.setText(jugadores.get(i).getNombre());
                    break;
                case 1:
                    this.lblJugador2.setIcon(new ImageIcon("src\\main\\resources\\" + jugadores.get(i).getAvatar()));
                    this.lblNombre2.setText(jugadores.get(i).getNombre());
                    break;
                case 2:
                    this.lblJugador3.setIcon(new ImageIcon("src\\main\\resources\\" + jugadores.get(i).getAvatar()));
                    this.lblNombre3.setText(jugadores.get(i).getNombre());
                    break;
                case 3:
                    this.lblJugador4.setIcon(new ImageIcon("src\\main\\resources\\" + jugadores.get(i).getAvatar()));
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(200, 66));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblJugador1, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3.setPreferredSize(new java.awt.Dimension(200, 66));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblJugador3, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblNombre3, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(198, 66));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblJugador2, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblNombre2, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(15, 15, 15)
                        .addComponent(lblNombre2, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblJugador4, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(15, 15, 15)
                        .addComponent(lblNombre4, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jpSalaEsperaLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jpSalaEsperaLayout.createSequentialGroup()
                ...
                .addGroup(jpSalaEsperaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jpSalaEsperaLayout.createSequentialGroup()
                        .addGroup(jpSalaEsperaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void btnVotacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotacionActionPerformed
        if(sck.enviarAlServidor(MensajeSockets.VOTO)){
            if (this.btnVotacion.getText().equals("VOTAR")) {
                this.btnVotacion.setText("CANCELAR VOTO");
            } else if (this.btnVotacion.getText().equals("CANCELAR VOTO")) {
                this.btnVotacion.setText("VOTAR");
            }
        }
